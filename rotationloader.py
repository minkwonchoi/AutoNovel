...
class GenericDataset(data.Dataset):
    def __init__(self, dataset_name, split, random_sized_crop=False,
        ...
        # elif self.dataset_name=='CUB_200_2011.tgz':
        #     self.mean_pix = [0.485, 0.456, 0.406]
        #     self.std_pix = [0.229, 0.224, 0.225]

        #     if self.random_sized_crop:
        #         raise ValueError('The random size crop option is not supported for the CUB_200_2011.tgz dataset')
        ...
        #     raise ValueError('Not recognized dataset {0}'.format(dataset_name))
            ...
            if self.random_sized_crop:
                raise ValueError('The random size crop option is not supported for the CUB_200_2011 dataset')
    ...
    def get_iterator(self, epoch=0):
        ...
        if self.unsupervised:
            ...
            def _load_function(idx):
                ...
                print([t.shape for t in rotated_imgs])
